...
export const primaryButtonClass =
  "inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#1D24CA] to-[#3D45E0] text-sm font-bold text-white shadow-xl shadow-[#1D24CA]/25 transition hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-[#1D24CA]/30 disabled:pointer-events-none disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-xl";
