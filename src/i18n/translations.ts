...
export const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    "auth.googleSignup.subdomainAvailable": "متاح. يمكنك استخدام هذا الدومين الفرعي.",
  ...
  en: {
    ...
    "auth.googleSignup.subdomainHint": "Type your subdomain to check availability.",
    "auth.googleSignup.subdomainMin": "Minimum 3 characters.",
    "auth.googleSignup.subdomainChecking": "Checking availability...",
    "auth.googleSignup.subdomainAvailable": "Available. You can use this subdomain.",
