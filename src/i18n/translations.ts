...
export const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    "hero.cta1": "ابدأ موقعك الآن",
    "hero.cta2": "شوف القوالب",
    "hero.ctaVideo": "شاهد شرح المنصة",
    "hero.bullet1": "اختار شكل قريب من مجالك",
    "hero.bullet2": "رتّب محتواك بدون تعقيد",
    "hero.bullet3": "انشر رابطك وشاركه بثقة",
    "hero.stat1.value": "+20",
    ...
    "dashboard.goToEditor": "اذهب إلى محرر الموقع",
  ...
  en: {
    ...
    "hero.cta1": "Start your site",
    "hero.cta2": "View templates",
    "hero.ctaVideo": "Watch platform tour",
    "hero.bullet1": "Choose a layout for your field",
    "hero.bullet2": "Organize content without friction",
    "hero.bullet3": "Publish and share with confidence",
    "hero.stat1.value": "20+",
    ...
    "dashboard.goToEditor": "Go to site editor",
